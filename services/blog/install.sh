#!/usr/bin/env bash
# Install Blog (Astro statique/SSR, image officielle GHCR, sans deploy.sh
...
# PROVIDER=github, WORKFLOW=<nom workflow CI>, BRANCH=main
#
# Aucun secret applicatif au runtime (blog statique, tout bake dans l'image
# au build CI).
